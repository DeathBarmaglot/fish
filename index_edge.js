...
//images folder
var im='https://raw.githubusercontent.com/DeathBarmaglot/fish/summer/images/';
...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'ref',
                type: 'image',
                rect: ['325px', '-17px','106px','201px','auto', 'auto'],
            ...
            },
            {
                id: 'akk2',
                type: 'image',
                rect: ['284px', '-138px','29px','400px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"akk.png",'0px','0px'],
                transform: [[],[],[],['0.28','0.28'],['25%']]
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid237", tween: [ "style", "${_akk2}", "opacity", '1', { fromValue: '0'}], position: 8835, duration: 1539 },
                ...
                { id: "eid77", tween: [ "style", "${_ref}", "left", '203px', { fromValue: '325px'}], position: 9185, duration: 543, easing: "easeInOutQuad" },
